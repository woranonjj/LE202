...
### ภาษาassembly นั้นคอมพิวเตอร์ยังไม่สามารถเข้าใจได้จึงต้องแปลงเป็นโค้ดที่เป็น Binary ก่อนและในแต่ละยี่ห้อนั้นก็จะมีภาษาเครื่องที่แตกต่างกัน
...
### ทั้งนี้ภาษา assembly และ ภาษาเครื่องนั้นจะแตกต่างกันตามยี่ห้อของ microcontroller
